...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="nav-links">
      ...
      <li><a href="{{ route('landing.contact') }}" class="active">Contact</a>
      </li>
    </ul>
  ...
  <div
    style="padding: 120px 60px 60px; min-height: 100vh; background: #f9f9f9;">
    ...
    @if (session('success'))
      <div
        style="background: #e8f5e9; color: #025628; padding: 14px 20px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #025628;">
        <i class="fas fa-check-circle"></i> {{ session('success') }}
      </div>
    @endif

    <div
      style="display: grid; grid-template-columns: 1fr 2fr; gap: 40px; background: white; border: 1px solid #eee; border-radius: 12px; padding: 40px; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">

      <div style="display: flex; flex-direction: column; gap: 30px;">

        <div style="display: flex; gap: 16px; align-items: flex-start;">
          <div
            style="width: 50px; height: 50px; background: #025628; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <i class="fas fa-phone" style="color: white; font-size: 18px;"></i>
          </div>
          <div>
            <h4
              style="font-size: 16px; font-weight: 700; color: #1a1a1a; margin-bottom: 6px;">
              Call To Us</h4>
            <p
              style="font-size: 13px; color: #888; line-height: 1.6; margin-bottom: 6px;">
              We are available 24/7, 7 days a week.</p>
            <p style="font-size: 13px; color: #444;">Phone: +88015-88888-9999
            </p>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 16px; align-items: flex-start;">
          ...
          <div>
            ...
            <p style="font-size: 13px; color: #444;">Emails: Regals@gmail.com
            </p>
            <p style="font-size: 13px; color: #444;">Emails:
              support@ledipo.gov.ph</p>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 16px; align-items: flex-start;">
          ...
          <div>
            ...
            <p
              style="font-size: 13px; color: #888; line-height: 1.6; margin-bottom: 6px;">
              Come visit us at our office.</p>
            <p style="font-size: 13px; color: #444;">Barangay Burol Main, City
              of Dasmariñas, Cavite, Philippines.</p>
          </div>
        </div>
