  ...
  <div class="mc_list">
    @forelse($enrollments as $enrollment)
      <div class="mc_row">
        ...
        <div class="mc_info">
          ...
          <div class="mc-sub">{{ $enrollment->course->sector }} &middot;
            {{ $enrollment->course->duration }}</div>
          <div class="mc-pbar">
            <div class="mc-pfill"
        ...
        <div class="mc_right">
          @if ($enrollment->status === 'completed')
            ...
            <a href="{{ route('course.detail', $enrollment->course->id) }}"
              class="mc-btn mc-btn-done">
              Review
            </a>
          @else
    ...
    @empty
      <div class="empty_state">
        ...
        <a href="{{ route('all.courses') }}" class="btn-enroll-now">Browse
          Courses</a>
      </div>
    @endforelse
  </div>
    ...
    @forelse($deadlines as $deadline)
      ...
      <div class="dl-row">
        ...
        <div class="dl-info">
          ...
          <div class="dl-date">Due
            {{ \Carbon\Carbon::parse($deadline->due_date)->format('F d, Y') }}
          </div>
        </div>
