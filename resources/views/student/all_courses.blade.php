            ...
            <div class="course-card">
                ...
                <div class="course-body">
                    ...
                    <div class="course-meta">
                        ...
                        <p><i class="fa fa-users"></i> {{ $course->available_slots }} slots</p>
                    </div>
                    ...
                    @if($isLocked)
                        <div class="btn-locked"><i class="fa fa-lock"></i> Limit Reached</div>
                    @else
                        <a href="{{ route('course.detail', $course->id) }}" class="btn-view-course">
                            View Course
                        </a>
                    @endif
                </div>
