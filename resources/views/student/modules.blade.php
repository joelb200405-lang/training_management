...
.mod-course-select:focus { border-color: #025628; }
...
.mod-icon.doc  { background: #e8eefe; }
.mod-icon.vid  { background: #e8f5e9; }
...
.quiz-btn-take:hover { background: #013d1c; }
...
<div class="mod-wrap">
    ...
    <div class="mod-header">
        ...
        <form method="GET" action="{{ route('student.modules') }}" id="courseSwitchForm">
    ...
    <div class="mod-card">
        ...
        <div class="mod-item">
            ...
            <div class="mod-info">
                ...
                <div class="mod-sub">
                    {{ strtoupper($ext) ?: 'FILE' }} · {{ $enrollment->course->title ?? '' }}
                </div>
            </div>
            @if($module->file_path)
            <a href="{{ asset('storage/' . $module->file_path) }}"
               download class="mod-dl-btn">
    ...
    <div class="mod-card">
        ...
        <div class="mod-progress-row">
            ...
            <div class="mod-pbar-bg">
                <div class="mod-pbar-fill" style="width: {{ $enrollment->progress ?? 0 }}%"></div>
            </div>
        ...
        <div class="quiz-item" id="quiz-item-{{ $quiz->id }}">
            ...
            @if($result)
                <span class="{{ $result->status === 'passed' ? 'quiz-score-passed' : 'quiz-score-failed' }}">
