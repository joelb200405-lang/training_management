...
@section('content')
  <div class="panel-padding">
    ...
    <section class="stats-grid" style="margin:0 0 24px;">
      ...
      <div class="stat-card">
        <h3>52</h3>
        <p>Employment Ready</p>
      </div>
      <div class="stat-card">
        <h3>Sabang</h3>
        <p>Top Barangay Reach</p>
      </div>
      <div class="stat-card">
        <h3>60/70</h3>
        <p>Gender Split (F/M)</p>
      </div>
    </section>
    ...
    <div class="reports-left-workspace">
      ...
      <div class="report-filter-card">
        ...
        <div class="filter-grid">
          ...
          <input type="month" class="report-select" id="dateFilter"
            value="2026-03">
      ...
      <div class="preview-container">
        <div class="preview-header"
          style="padding:12px 16px;background:#fafff8;border-bottom:1px solid #eee;">
          <span id="recordStatus">Showing <strong>45 records</strong> for March
            2026</span>
        </div>
      ...
      <div class="export-footer">
        <button class="btn-export excel"><i class="fas fa-file-excel"></i> Export
          Excel</button>
        <button class="btn-export pdf"><i class="fas fa-file-pdf"></i> Export
          PDF</button>
        <button class="btn-export print" onclick="window.print()"><i
  ...
  <script>
    function updatePreview() {
      ...
      setTimeout(() => {
        ...
        status.innerHTML =
          `Showing <strong>${count} records</strong> for the selected criteria.`;
    ...
    function exportData(type) {
      if (type === 'PDF') {
        if (confirm(
          "Generate official report with the City Mayor's Letterhead?")) {
          window.print();
        }
      } else {
        alert(
          `Data successfully converted to ${type} and saved to your Downloads folder.`
          );
      }
    }
      ...
      if (ctxPie) {
        new Chart(ctxPie.getContext('2d'), {
          ...
          data: {
            ...
            datasets: [{
              data: [40, 25, 20, 15],
              backgroundColor: [primaryGreen, secondaryGreen,
                '#2e7d32', accentYellow
              ],
              borderWidth: 2
            }]
