...
<style>
    ...
    .badge-red    { display:inline-block;background:#fef2f2;color:#c53030;font-size:11px;padding:2px 8px;border-radius:999px;margin-top:6px; }
    ...
    /* ── Student table ────────────────────────────────────────────────────── */
    .tbl-card { background: white; border-radius: 12px; border: 0.5px solid #e2e8f0; overflow: hidden; margin-bottom: 24px; }
    .tbl-head { display: flex; justify-content: space-between; align-items: center; padding: 14px 18px; border-bottom: 0.5px solid #f0f4f8; }
    .tbl-head span { font-size: 13px; font-weight: 600; color: #4a5568; }
    .tbl-head a   { font-size: 12px; color: #1a4d2e; font-weight: 600; text-decoration: none; }
    .tbl-card table { width: 100%; border-collapse: collapse; font-size: 13px; }
    .tbl-card th { font-size: 11px; color: #a0aec0; font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em; padding: 10px 18px; text-align: left; border-bottom: 0.5px solid #f0f4f8; }
    .tbl-card td { padding: 11px 18px; color: #4a5568; border-bottom: 0.5px solid #f8f9fa; }
    .tbl-card tr:last-child td { border-bottom: none; }
    .prog-bar { background: #e8f5e9; border-radius: 999px; height: 6px; width: 90px; overflow: hidden; display: inline-block; vertical-align: middle; }
    .prog-fill { background: #1a4d2e; height: 6px; border-radius: 999px; }
    .prog-fill-warn { background: #f5c842; }
    .prog-fill-red  { background: #e05c6e; }
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;align-items:center;gap:8px;">
                            <div class="prog-bar">
                                <div class="prog-fill {{ $s->progress < 25 ? 'prog-fill-red' : 'prog-fill-warn' }}"
