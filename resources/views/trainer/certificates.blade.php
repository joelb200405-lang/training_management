...
<head>
    ...
    <link rel="stylesheet" href="stylesheet/certificates.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li class="certificates"><a href=" "><i class="fas fa-certificate"></i> Certificates</a></li>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (traineeSelect) {
                traineeSelect.addEventListener('change', function() {
                    ...
                    console.log("System verified: " + fullName + " has a Passed status.");
                });
            }
         ...
         */
        function handleSave(actionType) {
            const trainee = document.getElementById('traineeSelect').value;
            
            if (!trainee) {
                alert("Please select a Passed Trainee first.");
                return;
            }

            if (actionType === 'pdf') {
                alert("Generating Soft Copy... Record Saved to Vault.");
            } else {
                alert("Sending to Office Printer... Physical Record Marked as Pending.");
            }
