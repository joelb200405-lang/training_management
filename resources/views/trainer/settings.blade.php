      ...
      <div class="settings-body-area">
        ...
        <div id="account" class="tab-panel active">
          ...
          <div class="form-row">
            ...
            <input type="text" class="custom-input" value="DCTC-2026-001"
        ...
        <div id="institution" class="tab-panel">
          <div class="form-row">
            ...
            <input type="text" class="custom-input"
              value="Dasmariñas City Training Center">
          </div>
          <div class="form-row">
            <label>Office Address</label>
            <input type="text" class="custom-input"
              placeholder="Barangay Burol Main, Cavite">
          </div>
          <div class="form-row">
        ...
        <div id="users" class="tab-panel">
          ...
          <div class="form-row">
            ...
            <button class="btn-action-outline"><i class="fas fa-user-plus"></i>
        ...
        <div class="settings-action-row">
          <button class="btn-dark-green" onclick="saveAllSettings()">Save All
            Changes</button>
        </div>
      </div>
    </div>
