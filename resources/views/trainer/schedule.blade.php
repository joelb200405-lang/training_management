...
@section('content')
  <div class="sc-wrap">
    ...
    <div class="sc-page-sub">Your assigned course schedule and session details.
    </div>
        ...
        <div class="sc-info-list">
          ...
          <div class="sc-info-row">
            ...
            <div>
              ...
              <div class="sc-info-value">{{ $course->schedule ?? 'Not set' }}
              </div>
            </div>
          </div>
          ...
          <div class="sc-info-row">
            ...
            <div>
              ...
              <div class="sc-info-value">{{ $course->duration ?? 'Not set' }}
              </div>
            </div>
          </div>
          ...
          <div class="sc-info-row">
            ...
            <div>
              ...
              <div class="sc-info-value">{{ $course->location ?? 'Not set' }}
              </div>
            </div>
          </div>
          ...
          <div class="sc-info-row">
            ...
            <div>
              ...
              <div class="sc-info-value">{{ $totalStudents }} /
                {{ $course->slots ?? '—' }} slots</div>
            </div>
          </div>
          ...
          <div class="sc-info-row">
            ...
            <div>
              ...
              <div class="sc-info-value">
                <span
                  style="display:inline-block;font-size:12px;font-weight:600;padding:3px 12px;border-radius:20px;
