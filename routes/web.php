...
// First Time Reset (Auth Only)
Route::get('/first-reset', [UserController::class, 'firstResetPage'])->middleware('auth')->name('first.reset');
Route::post('/first-reset', [UserController::class, 'firstResetSave'])->middleware('auth')->name('first.reset.save');
...
Route::middleware('admin')->group(function () {
    ...
    Route::put('/admin/announcement/{id}', [UserController::class, 'updateAnnouncement']);    Route::delete('/admin/announcement/{id}', [UserController::class, 'destroyAnnouncement'])->name('admin.announcement.destroy');
